...
class Cartella:
    ...
    def get_coordinate_numero(self, numero: int) -> tuple[int, int] | None:
        ...
        - Usa un controllo rapido su self.numeri_cartella per evitare scansioni inutili quando il numero non appartiene
          alla cartella.
        """
