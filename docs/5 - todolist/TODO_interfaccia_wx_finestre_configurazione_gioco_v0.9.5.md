...
- [ ] Creare la struttura wx del frame di configurazione
- [ ] Posizionare il focus iniziale sul primo controllo utile
- [ ] Collegare i controlli minimi a ComandiSistema
- [ ] Gestire conferma ed errori senza spostare logica di dominio nella UI

### Passo 2 - Transizione al frame di gioco

- [ ] Aprire il frame di gioco principale dopo configurazione valida
- [ ] Passare la partita creata al nuovo frame
- [ ] Garantire annuncio naturale del cambio finestra via titolo frame
- [ ] Chiudere o nascondere il frame precedente in modo coerente

### Passo 3 - Finestra di gioco principale

- [ ] Creare il pannello griglia focalizzabile
- [ ] Impostare focus iniziale sulla griglia all'apertura
- [ ] Implementare Escape per uscire dalla griglia e Tab per rientrare
- [ ] Aggiungere il pulsante principale a due stati
- [ ] Aggiungere area log annunci consultabile

### Passo 4 - Binding e dialog di ricerca

- [ ] Implementare i binding categoria A sul pannello griglia
- [ ] Implementare i binding categoria B sul frame principale
- [ ] Introdurre Ctrl+F con dialog modale di ricerca numero
- [ ] Vocalizzare il risultato nel dialog prima della chiusura
- [ ] Ripristinare il focus alla posizione precedente

### Passo 5 - Stato locale renderer e annunci

- [ ] Aggiungere buffer ultimo annuncio per F6
- [ ] Aggiornare il log annunci in parallelo alla vocalizzazione AO2
- [ ] Garantire che bot e premi non rubino il focus
- [ ] Collegare Ctrl+E alla consultazione della cronologia annunci

### Passo 6 - Validazione

- [ ] Eseguire test non-GUI impattati dai wrapper UI
